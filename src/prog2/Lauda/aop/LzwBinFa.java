...
public class LzwBinFa {
 ...
 private Csomopont jobbEgy = null;
	...
	public static void usage(){
	        System.out.println("usage: java LzwBin in_file -o out_file");
    	}
	...
	try{
		...
		binFa.kiir(kiFile);
		kiFile.println("mélység = " + binFa.getMelyseg());
		kiFile.println("átlag = " + binFa.getAtlag());
		kiFile.println("szórás = " + binFa.getSzoras());
