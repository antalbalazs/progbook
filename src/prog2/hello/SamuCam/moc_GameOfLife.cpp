...
QT_MOC_LITERAL(1, 11, 12), // "cellsChanged"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "int**"
QT_MOC_LITERAL(4, 31, 10), // "updateFace"
QT_MOC_LITERAL(5, 42, 7), // "QImage*"
QT_MOC_LITERAL(6, 50, 4) // "face"

    },
    "GameOfLife\0cellsChanged\0\0int**\0"
    "updateFace\0QImage*\0face"
};
...
void GameOfLife::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cellsChanged((*reinterpret_cast< int**(*)>(_a[1])),(*reinterpret_cast< int**(*)>(_a[2])),(*reinterpret_cast< int**(*)>(_a[3])),(*reinterpret_cast< int**(*)>(_a[4]))); break;
        ...
        {
            typedef void (GameOfLife::*_t)(int * * , int * * , int * * , int * * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameOfLife::cellsChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject GameOfLife::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_GameOfLife.data,
...
// SIGNAL 0
void GameOfLife::cellsChanged(int * * _t1, int * * _t2, int * * _t3, int * * _t4)
{
